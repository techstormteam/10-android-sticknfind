    ...
    LeSnfDeviceDelegate leSnfDeviceDelegate = new LeSnfDeviceDelegate(){
		...
		public void didSetBroadcastKeyForLeSnfDevice(LeDevice dev,
			...
			if (success){
				...
				Log.e(TAG, "Data: " + ((LeSnfDevice) dev).setAdvertisementData_v2(data, 5, 1, 0, false, LeSnfDevice.ADV_TYPE.ADV_CONNECTABLE, 0x76, 7, 8, 5, 16, 7, 0));
			}
		}
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	public static void onReceiveMessage(Message msg) {
		...
		case Singleton.MG_MSG_MELODY:
			...
			break;
		case Singleton.MG_MSG_BROADCASTADVNAME:
			setBroadcastAdvname((LeDevice)msg.obj);
			break;
