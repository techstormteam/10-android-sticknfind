...
public class Singleton {
	...
	public final static int MH_MSG_DEVICE_CBOND = 109;
	public final static int MH_MSG_RESET_STICKER = 110;
	public final static int MH_MSG_SEND_CC = 111;
	public final static int MG_MSG_READ_ADV_SETTINGS = 112;
	public final static int MG_MSG_TEMPERATURE_ON = 113;
	public final static int MG_MSG_NAMEIT = 114;
	public final static int MG_MSG_PUTASLEEP = 115;
	public final static int MG_MSG_MELODY = 116;
...
///////////////////////////////////////////////////////////////////////////////////
	...
	public synchronized static void incomingMessage(Message msg){
		...
		case MH_MSG_PHONE_NOT_SUPPORTED:
			...
			break;
		case MH_MSG_BEACON_UPDATE:
			Singleton.uiContext.updateBeacon1List((LeDevice)msg.obj);
			break;
